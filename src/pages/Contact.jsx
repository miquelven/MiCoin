...
export default function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>MiCoin - Contact</title>
        <meta
          name="description"
          content="Get in touch with us at MiCoin to discuss cryptocurrency inquiries, partnerships, or technical support. Our team is here to assist you with any questions you may have about our platform or cryptocurrency-related matters. Reach out to us today and let's navigate the world of cryptocurrencies together."
        />
        <meta
          name="keywords"
          content="cryptocurrency, crypto, bitcoin, blockchain, ethereum, digital currency, cryptocurrency market, cryptocurrency news, cryptocurrency prices, cryptocurrency trading"
        />
